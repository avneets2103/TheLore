...
export default function Home() {
  return (
    <>
      ...
      <div className="h-[100vh] w-[100vw] bg-black flex justify-center items-center" id="skills">
        <AncientPowers/>
      </div>
      <div className="h-screen w-screen bg-grid-white/[0.2] relative flex items-center justify-center bg-black" id="projects">
