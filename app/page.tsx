...
export default function Home() {
  return (
    <>
      ...
      <div className="section relative flex h-[100vh] w-[100vw] flex-row items-start justify-center bg-black" id="TARS">
        <EntryPage />
      </div>
      <div className="section relative flex h-[100vh] w-[100vw] bg-black" id="hype">
        <Dawg />
      </div>
      <div className="section flex h-[100vh] w-[100vw] flex-col bg-black" id="college">
        <Forest />
        <ForestLore />
      </div>
      <div className="section h-fit lg:h-[100vh] w-[100vw] bg-black flex justify-center items-center" id="skills">
        <AncientPowers/>
      </div>
      <div className="section mt-[10vh] lg:mt-0 h-fit lg:h-screen w-screen lg:bg-grid-white/[0.2] relative flex items-center justify-center bg-black" id="projects">
      ...
      <div className="section bg-grid-white/[0.2] relative flex items-center justify-center bg-black" id="experience">
        <div className="pointer-events-none absolute inset-0 flex items-center justify-center bg-black [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]"></div>
        <TimelineDemo />
      </div>
      <div className="section h-screen w-screen bg-black relative" id="trinity">
        <Trinity />
      </div>
    </>
  );
