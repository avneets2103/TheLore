  ...
  return (
    ...
    >
      <div
        ...
        className="group/card rounded-3xl w-full relative overflow-hidden bg-transparent flex items-center justify-center h-full p-5"
      >
        <CardPattern
          mouseX={mouseX}
          mouseY={mouseY}
        ...
        <div className="relative z-10 flex items-center justify-center p-5">
          <div className="relative h-40 w-40 rounded-full flex items-center justify-center text-primaryColor font-bold text-3xl">
            <div className="absolute w-full h-full bg-white/[0.8] dark:bg-black/[0.4] blur-sm rounded-full" />
            <span className="text-gray-300 z-20">{text}</span>
          </div>
        </div>
      </div>
    </div>
